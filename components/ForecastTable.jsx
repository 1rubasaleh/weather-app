  ...
  return (
    <section className="w-full max-w-5xl mx-auto">
      <div
        ...
        className="text-white my-4 pt-5 px-4 md:px-6 pb-3"
      >
        <p className="font-bold text-[22px] leading-7">5-Day Forecast</p>
      </div>

      <div className="border border-[#384757] rounded-[12px] w-full px-0 md:px-0 md:max-w-[926px] mx-auto overflow-hidden">
        <div
          style={{ fontFamily: "var(--font-space)" }}
          className="hidden md:grid md:grid-cols-[200px_220px_300px_1fr] px-6 h-[46px] items-center text-[14px] text-slate-300 bg-[#1C2129] border-b border-gray-400"
        >
          <span>Day</span>
